...
\begin{enumerate}[label=(\alph*)]
	\item	\begin{align*}
			...
			\end{tabular}
			\end{center}
	\item	$\mathcal{G}$ ist nicht fundiert, da es unendliche Partien gibt (z.B. $(6,8,6,8,\dots)$).\\
			$\mathcal{G}$ ist determiniert, $W_0 \cup W_1 = V$
	\item	Wenn Spieler $1$ vorher die Position $9$ entfernt, hat nun Spieler $1$ eine Gewinnstrategie für jede Position und Spieler $0$ hat keine mehr. Sprich, Spieler $1$ gewinnt dann immer.
\end{enumerate}
