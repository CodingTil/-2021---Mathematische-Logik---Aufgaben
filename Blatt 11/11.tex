...
$$\Psi \coloneqq \{\forall x \forall y (Exy \rightarrow Eyx)\} \cup \{\psi_n \mid n \in \N\setminus\{0\}\}$$
...
Sei $\Psi_0 \coloneqq \Theta_0 \cap \Psi$. Es existert wegen Endlichkeit ein $m \in \N\setminus\{0\}$, sodass $\psi_n \not\in \Psi_0$ für alle $n \geq m$. Es folgt $\Psi_0 \subseteq \{\forall x \forall y (Exy \rightarrow Eyx)\} \cup \{\psi_n \mid n < m\}$\\
