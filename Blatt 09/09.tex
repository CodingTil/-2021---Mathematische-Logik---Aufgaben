...
\section*{Aufgabe 3}
\begin{prooftree}
			\AxiomC{$c_1 < c_2, c_2 < c_1 \Rightarrow t_1 < t_1, t_2 < t_3$}
			\AxiomC{$c_1 < c_2, c_2 < c_1 \Rightarrow t_1 < t_1, t_3 < t_4$}
		
		\LeftLabel{$(\Rightarrow \land)$}
		\BinaryInfC{$c_1 < c_2, c_2 < c_1 \Rightarrow t_1 < t_1, t_2 < t_3 \land t_3 < t_4$}		
		
		\AxiomC{$t_2 < t_4, c_1 < c_2, c_2 < c_1 \Rightarrow t_1 < t_1$}
	
	\LeftLabel{$(\impl \Rightarrow)$}
	\BinaryInfC{$(t_2 < t_3 \land t_3 < t_4) \impl t_2 < t_4, c_1 < c_2, c_2 < c_1 \Rightarrow t_1 < t_1$}
	
	\LeftLabel{$(\land \Rightarrow)$}
	\UnaryInfC{$(t_2 < t_3 \land t_3 < t_4) \impl t_2 < t_4, c_1 < c_2 \land c_2 < c_1 \Rightarrow t_1 < t_1$}
	
	\LeftLabel{$(\neg \Rightarrow)$}
	\UnaryInfC{$\neg t_1 < t_1, (t_2 < t_3 \land t_3 < t_4) \impl t_2 < t_4 \Rightarrow \neg (c_1 < c_2 \land c_2 < c_1)$}
	
	\LeftLabel{$(\Rightarrow \forall)$}
	\UnaryInfC{$\neg t_1 < t_1, (t_2 < t_3 \land t_3 < t_4) \impl t_2 < t_4 \Rightarrow \forall y \neg (c_1 < y \land y < c_1)$}
	
	\LeftLabel{$(\Rightarrow \forall)$}
	\UnaryInfC{$\neg t_1 < t_1, (t_2 < t_3 \land t_3 < t_4) \impl t_2 < t_4 \Rightarrow \forall x \forall y \neg (x < y \land y < x)$}
	
	\LeftLabel{$(\forall \Rightarrow)$}
	\UnaryInfC{$\neg t_1 < t_1, \forall z ((t_2 < t_3 \land t_3 < z) \impl t_2 < z) \Rightarrow \forall x \forall y \neg (x < y \land y < x)$}
	
	\LeftLabel{$(\forall \Rightarrow)$}
	\UnaryInfC{$\neg t_1 < t_1, \forall y \forall z ((t_2 < y \land y < z) \impl t_2 < z) \Rightarrow \forall x \forall y \neg (x < y \land y < x)$}
	
	\LeftLabel{$(\forall \Rightarrow)$}
	\UnaryInfC{$\neg t_1 < t_1, \forall x \forall y \forall z ((x < y \land y < z) \impl x < z) \Rightarrow \forall x \forall y \neg (x < y \land y < x)$}
