...
\begin{enumerate}[label=(\alph*)]
	...
	\item	Beobachtungen:
			...
			\end{itemize}
			Sei $G_\tau$ die Menge aller Grundterme über $\tau$, $F_\tau \subseteq G_\tau$ Menge aller funktionalen Grundterme, $R_\tau \subseteq G_\tau$ Menge aller relationalen Grundterme.
			\begin{align*}
				\Sigma &= \{t = t' \mid t,t' \in F_\tau, \text{ in } t \text{ bzw. } t' \text{ kommen } k \geq 1 \text{ bzw. } m \geq 1 \text{ } f \text{ vor, mit } k = 4 \cdot z \cdot m, z \in \Z\} \\
					&\cup \{t = c_1, c_1 = t \mid t \in F_\tau, \text{ in } t \text{ kommt } f \text{ } k \text{-mal vor, mit } k = 4 \cdot (1 + n), n \in \N\} \\
					&\cup \{c_0 = c_0, c_1 = c_1\} \\
